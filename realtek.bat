...
if not defined SNDCPY_APK set SNDCPY_APK=audio.apk
if not defined SNDCPY_PORT set SNDCPY_PORT=28200

if not "%1"=="" (
    set serial=-s %1
    echo Dang cho thiet bi %1...
) else (
    echo Dang cho thiet bi...
)
...
echo Da truyen am thanh thanh cong ban co the dong cua so nay (vnroid.com)...
